...
float point_segment_distance_field(const Vec3f &x0, const Vec3f &x1, const Vec3f &x2, Vec3f &r)
{
   Vec3f dx(x2-x1);
   double m2=mag2(dx);
...
float point_triangle_distance_field(const Vec3f &x0, const Vec3f &x1, const Vec3f &x2, const Vec3f &x3, Vec3f &r)
{
   ...
   if(w23>=0 && w31>=0 && w12>=0){ // if we're inside the triangle
      ...
      if(w23>0){ // this rules out edge 2-3 for us
         ...
         float d1 = point_segment_distance_field(x0,x1,x2,r1);
         float d2 = point_segment_distance_field(x0,x1,x3,r2);
         ...
         float d1 = point_segment_distance_field(x0,x1,x2,r1);
         float d2 = point_segment_distance_field(x0,x2,x3,r2);
         ...
         float d1 = point_segment_distance_field(x0,x1,x3,r1);
         float d2 = point_segment_distance_field(x0,x2,x3,r2);
